            ...
            <div style={{padding: isMobile ? '14px' : '24px'}}>
              ...
              {step === 'uploading' && (
                <div style={{textAlign:'center',padding:'24px 0'}}>
                  ...
                  <h3 style={{fontFamily:"'Cabinet Grotesk',sans-serif",fontSize:'17px',fontWeight:700,marginBottom:'10px'}}>Subiendo tu video...</h3>
                  ...
                  <p style={{fontSize:'12px',color:'var(--c)',fontWeight:700,fontFamily:'monospace',marginBottom:'16px'}}>{progreso}%</p>
                  <button onClick={cancelarSubida} style={{display:'inline-flex',alignItems:'center',gap:'6px',background:'none',border:'1px solid rgba(255,255,255,.15)',color:'var(--t2)',padding:'8px 18px',borderRadius:'8px',fontSize:'13px',fontWeight:600,cursor:'pointer'}}>
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                    Cancelar subida
                  </button>
                  <p style={{fontSize:'11px',color:'var(--t3)',marginTop:'8px'}}>Si cancelas, no se descuentan tus créditos.</p>
                </div>
              )}
